...
基本音级：具有独立名称的音级，有 C D E F G A B ，有的讲解也称为**音名** 。对应钢琴键如下图。
...
#### 关于音名和数字
简谱数字和唱名一定是一一对应，但音名和数字/唱名就不一定对应。后面会详细再解释。
...
**音域**是最低音至最高音的范围，可以分为总音域、乐器音域、人声音域（例如男中音、女高音）。
...
### 半音和全音
- 自然半音：相邻两个音级构成的半音关系。注意这个是理论上的，不是跟乐器实体构造对应。
- 自然全音：相邻两个音级构成的全音关系。
