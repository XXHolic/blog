...
在看日本一些番剧的时候，有一个特别深刻的印象：角色主动解说看到的状况。比如 JOJO 里面发动替身技能的时候，总是会有人进行言语上或者心理上的“说明”。这种方式跟实际生活体验很不一样，就好比当看到两条狗在打架时，你会在旁边用文字描述说出来。虽然说不合常理，但还是有效的调动了部分观看者的情绪，至少对我是有效果的。
