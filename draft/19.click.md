...
### hammer
从 github 上下载了最新的源码，先写了个简单的demo，发现就算直接把官方的示例贴过来都没效果。想着是不是引用出了问题，hammer.js 的引用换了一个远程的链接，写的demo就有效果了，再写了个demo进行对比，真的是最新的 master 分支上的代码有问题。对比了一下正式发布的版本和最新的代码，发现最新的文件结构和 js 写法上有了很多改变，但没有正式发布。以下的逻辑基于正式发布的版本。
