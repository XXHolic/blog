...
在 [2012-07-25 Meeting Notes][url-2012-07-25-meeting-note] 中，再次对 `Object.observe` 进行了讨论，结论是打算实现原型，然后在实际中初步尝试使用。
...
### 2014
在 [2013-01-29 Meeting Notes][url-2013-01-29-meeting-note] 中，对 `Object.observe` 进行了一次报告，讨论中想要把这个提议推进到第二个阶段，讨论了相关任务的排期，但最终并没有结论。

在 [2013-04-09 Meeting Notes][url-2013-04-09-meeting-note] 中，对 `Object.observe` 进行了更新。
...
[url-2014-01-29-meeting-note]:https://esdiscuss.org/notes/2014-01-29#objectobserve-status-report
[url-2014-04-09-meeting-note]:https://esdiscuss.org/notes/2014-04-09#objectobserve-update
