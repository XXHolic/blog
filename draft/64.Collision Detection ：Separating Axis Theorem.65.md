...
## <a name="start"></a> 引子
在 [Collision Detection ：Transformation][url-blog-63] 中介绍了动态的碰撞检测，[CollisionDetection][url-github-1] 项目的主要内容差不多都讲了。在查询资料的时候，还接触到一些其它的检测方法，也想介绍一下，现在来看一下另外一种检测方法： Separating Axis Theorem 。
